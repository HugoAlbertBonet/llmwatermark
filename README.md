...
**Under vLLM it is 5.2% against a 2% target** - the one place this project misses its own
goal. Numbers, method and what is still unexplained: [RESULTS.md](tests/benchmarks/RESULTS.md).
